...
func make_config(t *testing.T, n int, unreliable bool, snapshot bool) *config {
	...
	cfg.logger = logger.NewLogger(0, true, "Tester", loggingMap)
...
func (cfg *config) crash1(i int) {
	...
	cfg.logger.Log(LogKillServer, "Killed a server")
...
func (cfg *config) connect(i int) {
	...
	cfg.logger.Log(LogConnectServer, "Connected a server")
}
...
func (cfg *config) disconnect(i int) {
	...
	cfg.logger.Log(LogDisconnectServer, "Disconnected a server")
}
...
// to simplify the early Lab 4B tests.
...
// e.g. cfg.begin("Test (4B): RPC counts aren't too high")
